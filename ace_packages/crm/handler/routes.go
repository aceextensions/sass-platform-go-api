...
func RegisterRoutes(e *echo.Echo, custSvc service.CustomerService, suppSvc service.SupplierService) {
	// Create handlers
	customerHandler := NewCustomerHandler(custSvc)
	supplierHandler := NewSupplierHandler(suppSvc)
