...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_aceextension_notification_domain.Notification"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/notification_handler.TemplateResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/notification_handler.CreateTemplateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/subscription_handler.CreatePlanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/subscription_handler.SubscribeRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_aceextension_identity_dto.UserListResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_aceextension_identity_dto.InviteUserDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_aceextension_identity_dto.JoinTenantDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_aceextension_identity_dto.InviteUserDTO": {
            "type": "object",
            "required": [
                "role"
            ],
        ...
        "github_com_aceextension_identity_dto.JoinTenantDTO": {
            "type": "object",
            "required": [
                "name",
                "password",
        ...
        "github_com_aceextension_identity_dto.Pagination": {
            "type": "object",
            "properties": {
                "currentPage": {
                    "type": "integer"
        ...
        "github_com_aceextension_identity_dto.UserListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                ...
                "pagination": {
                    "$ref": "#/definitions/github_com_aceextension_identity_dto.Pagination"
                }
            }
        },
        ...
        "github_com_aceextension_notification_domain.ChannelType": {
            "type": "string",
            "enum": [
                "SMS",
                "EMAIL",
        ...
        "github_com_aceextension_notification_domain.Notification": {
            "type": "object",
            "properties": {
                "channel": {
                    "$ref": "#/definitions/github_com_aceextension_notification_domain.ChannelType"
                },
                "content": {
                    "type": "string"
                },
                ...
                "priority": {
                    "$ref": "#/definitions/github_com_aceextension_notification_domain.Priority"
                },
                "recipient": {
                    "type": "string"
                },
                ...
                "status": {
                    "$ref": "#/definitions/github_com_aceextension_notification_domain.NotificationStatus"
                },
                "subject": {
                    "type": "string"
                },
        ...
        "github_com_aceextension_notification_domain.NotificationStatus": {
            "type": "string",
            "enum": [
                "PENDING",
                "PROCESSING",
        ...
        "github_com_aceextension_notification_domain.Priority": {
            "type": "string",
            "enum": [
                "HIGH",
                "LOW"
        ...
        "notification_handler.CreateTemplateRequest": {
            "type": "object",
            "required": [
                "body",
                "channel",
        ...
        "notification_handler.TemplateResponse": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "subscription_handler.CreatePlanRequest": {
            "type": "object",
            "required": [
                "code",
                "name"
        ...
        "subscription_handler.SubscribeRequest": {
            "type": "object",
            "required": [
                "password",
                "planId"
